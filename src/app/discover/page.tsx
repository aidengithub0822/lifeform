    ...
    <div className="mx-auto max-w-md px-5 py-8">
      ...
      <div className="mt-8">
        ...
        <p className="mt-1 text-xs text-zinc-500">
          AI suggestions based on general knowledge — not live listings, so double-check hours and menus.
        </p>
            ...
            {places.map((place, i) => (
              <div key={`${place.name}-${i}`} className="lf-gradient-border p-3.5">
                <div className="flex items-baseline justify-between gap-2">
                  ...
                  <p className="shrink-0 text-xs font-medium text-zinc-400">{place.price_range}</p>
                </div>
